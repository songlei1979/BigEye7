# Generated by Django 3.0.8 on 2020-08-12 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eye.Case')),
                ('Investigator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eye.Investigator')),
            ],
        ),
        migrations.CreateModel(
            name='Allocation',
            fields=[
                ...
                ('Case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eye.Case')),
                ('Equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eye.Equipment')),
            ],
        ),
    ]
